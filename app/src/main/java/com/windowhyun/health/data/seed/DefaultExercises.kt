...
object DefaultExercises {
    ...
    private fun exercise(
        ...
        bodyPart: BodyPart,
    ) = ExerciseEntity(name = name, category = category, bodyPart = bodyPart, isBuiltIn = true)
    ...
    val all: List<ExerciseEntity> = listOf(
        ...
        exercise("딥스", ExerciseCategory.BODYWEIGHT, BodyPart.CHEST),
        exercise("푸시업", ExerciseCategory.BODYWEIGHT, BodyPart.CHEST),
        // 등
        ...
        exercise("풀업", ExerciseCategory.BODYWEIGHT, BodyPart.BACK),
        ...
        // 코어
        exercise("플랭크", ExerciseCategory.BODYWEIGHT, BodyPart.CORE),
        exercise("크런치", ExerciseCategory.BODYWEIGHT, BodyPart.CORE),
        exercise("행잉 레그레이즈", ExerciseCategory.BODYWEIGHT, BodyPart.CORE),
        exercise("케이블 크런치", ExerciseCategory.CABLE, BodyPart.CORE),
        // 전신
        exercise("케틀벨 스윙", ExerciseCategory.KETTLEBELL, BodyPart.FULL_BODY),
        exercise("버피", ExerciseCategory.BODYWEIGHT, BodyPart.FULL_BODY),
    )
}
